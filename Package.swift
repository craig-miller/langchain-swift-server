...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/seriyvolk83/SwiftyJSON", .upToNextMajor(from: "5.0.1")),
        // .package(url: "https://github.com/craig-miller/SwiftyJSON", .upToNextMajor(from: "0.0.1")),
